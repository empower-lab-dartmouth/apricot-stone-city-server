    ...
    convoSegments: [
        {
            ...
            convo: [
                ...
                {
                    type: 'image',
                    src: 'https://cdn.britannica.com/66/123766-050-9C662576/Dark-Hollow-Falls-Shenandoah-National-Park-Virginia.jpg',
                },
            ],
            choices: [
                {
        ...
        },
        {
            ...
            convo: [
                ...
                {
                    type: 'text',
                    text: 'Use this mini-game to explore more about output generation: guessingai.onrender.com',
                },
            ],
            choices: [
                {
